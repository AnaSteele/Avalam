...
void Plateau::testBasDroite(){
    if(((Depart.ligne+1)<0 || (Depart.ligne+1)>_nbrLignes) || (Depart.colonne+1<0 || Depart.colonne+1>_nbrColonnes))
            cout << "coordonnées hors plateau >> pas de deplacement possible en bas a droite" << endl;
    ...
    else cout << "pas de deplacement en bas a droite" << endl;
}

void Plateau::testBasGauche(){
    if(((Depart.ligne+1)<0 || (Depart.ligne+1)>_nbrLignes) || (Depart.colonne-1<0 || Depart.colonne-1>_nbrColonnes))
            cout << "coordonnées hors plateau >> pas de deplacement possible en bas a gauche" << endl;
    else if (plateau[Depart.ligne+1][Depart.colonne-1]==pionJaune || plateau[Depart.ligne+1][Depart.colonne-1]==pionRouge){
        cout << "Deplacement possible de votre pion en [" << Depart.ligne+1 << ";" << Depart.colonne-1 << "]" << endl;
        
    }
    else cout << "pas de deplacement en bas a gauche" << endl;
}

void Plateau::testHautDroite(){
    if(((Depart.ligne-1)<0 || (Depart.ligne-1)>_nbrLignes) || (Depart.colonne+1<0 || Depart.colonne+1>_nbrColonnes))
            cout << "coordonnées hors plateau >> pas de deplacement possible en haut a droite" << endl;
    else if(plateau[Depart.ligne-1][Depart.colonne+1]==pionJaune || plateau[Depart.ligne-1][Depart.colonne+1]==pionRouge){
        cout << "Deplacement possible de votre pion en [" << Depart.ligne-1 << ";" << Depart.colonne+1 << "]" << endl;
        
    }
    else cout << "pas de deplacement en haut a droite" << endl;
}

void Plateau::testHautGauche(){
    if(((Depart.ligne-1)<0 || (Depart.ligne-1)>_nbrLignes) || (Depart.colonne-1<0 || Depart.colonne-1>_nbrColonnes))
        cout << "coordonnées hors plateau >> pas de deplacement possible en haut à gauche" << endl;
    else if(plateau[Depart.ligne-1][Depart.colonne-1]==pionJaune || plateau[Depart.ligne-1][Depart.colonne-1]==pionRouge){
        cout << "Deplacement possible de votre pion en [" << Depart.ligne-1 << ";" << Depart.colonne-1 << "]" << endl;
        if(((Depart.ligne-1)<0 || (Depart.ligne-1)>_nbrLignes) || (Depart.colonne-1<0 || Depart.colonne-1>_nbrColonnes))
            cout << "coordonnées hors plateau >> pas de deplacement possible" << endl;
    }
    else cout << "pas de deplacement en haut a gauche" << endl;
}
